...
export default function EditCategoryPage({categorySelect ,categoryId, onNavigate, onBack, onSave }) {
  const isEditMode = !!categoryId;
  const [showInMenu, setShowInMenu] = useState(true);
  const [metaTitle, setMetaTitle] = useState('');
  const [metaDescription, setMetaDescription] = useState('');
  const [categoryImages, setCategoryImages] = useState([categorySelect.image]);
