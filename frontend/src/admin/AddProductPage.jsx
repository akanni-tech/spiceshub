...
import { addProduct } from "./hooks/adminServices";
...
export function AddProductPage({ onBack, onSave }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      onSave(response); // Pass the created product to parent
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-[#333333] text-2xl font-semibold">Add New Product</h1>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="border border-[#F0F0F0] rounded-lg bg-white">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                <label htmlFor="stock" className="block text-sm font-medium text-[#333333]">Stock in grams</label>
                <input
                  id="stock"
                  value={product.stock}
                  onChange={handleChange}
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <button
              onClick={handleSave}
              disabled={loading}
              className="w-full bg-[#99582A] hover:bg-[#7d4622] text-white px-4 py-2 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
